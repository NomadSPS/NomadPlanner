...
/**
 * Modern main frame using standard JFrame + JMenuBar + JToolBar.
 * Replaces MainRibbonFrame (which extends JRibbonFrame / Flamingo).
 * FlatLaf handles all rendering — no custom painting needed.
 */
public class ModernMainFrame extends JFrame implements FrameHolder {
    private static final long serialVersionUID = 1L;
    protected GraphicManager graphicManager;

    public ModernMainFrame(String name, String projectUrl, String server) throws HeadlessException {
        super(name);
